...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PA10     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = Internal_Temp_SCL_Pin|Internal_Temp_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PA10     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(Internal_Temp_SCL_GPIO_Port, Internal_Temp_SCL_Pin);

    HAL_GPIO_DeInit(Internal_Temp_SDA_GPIO_Port, Internal_Temp_SDA_Pin);
